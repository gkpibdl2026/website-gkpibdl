...
export default function NewRenungan() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        showToast('Renungan berhasil dibuat', 'success');
      ...
      showToast('Gagal membuat renungan', 'error');
    } finally {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-(--text-primary)">Tambah Renungan Baru</h1>
        <p className="text-gray-600 dark:text-gray-300 mt-1">
          Buat renungan harian baru untuk jemaat
        </p>
      </div>

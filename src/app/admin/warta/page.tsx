                ...
                <div key={warta.id} className="p-4 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <a 
                        href={`/admin/warta/${warta.id}/print`}
                        target="_blank"
                        className="p-3 text-gray-400 hover:text-purple-600 hover:bg-purple-50 dark:hover:bg-purple-900/30 rounded-xl transition-colors"
                        aria-label="Print"
                      >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
